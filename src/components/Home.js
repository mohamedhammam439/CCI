        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <NavDropdown title="الخدمات" id="basic-nav-dropdown">
              ...
              <NavDropdown.Item href="#action/3.2">الميزانيات</NavDropdown.Item>
              <NavDropdown.Item href="#action/3.3">التحديثات</NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="#action/3.4">المناقصات</NavDropdown.Item>
            </NavDropdown>{" "}
